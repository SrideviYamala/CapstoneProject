...
public class CustomerController {
	...
	public ModelAndView viewProfile(@RequestParam MultiValueMap<String, String> paramMap) {
		...
		mav.addObject("accBalance",bankAccountService.showBal(Integer.parseInt(paramMap.getFirst("accountNo"))));
	...
	public ModelAndView showEmployeeDetails(@RequestParam MultiValueMap<String, String> paramMap) {
		ModelAndView mav = new ModelAndView("customer-details");
		mav.addObject("customers",customerService.viewProfile(Integer.parseInt(paramMap.getFirst("customerId"))));
		//mav.addObject("bankaccounts",bankAccountService.showBal(Integer.parseInt(paramMap.getFirst("customerId"))));
		return mav;
	}
